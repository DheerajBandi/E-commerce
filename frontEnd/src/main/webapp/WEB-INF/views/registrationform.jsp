			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<form:input class="form-control" path="billingaddress.streetname"
						id="billingaddress.streetname"  placeholder="Street Name"/>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<form:input class="form-control" path="billingaddress.city"
						id="billingaddress.city" placeholder="City"/>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<form:input class="form-control" path="billingaddress.state"
						id="billingaddress.state" placeholder="State"/>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<form:input class="form-control" path="billingaddress.country"
						id="billingaddress.country" placeholder="Country"/>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<form:input class="form-control" path="billingaddress.zipcode"
						id="billingaddress.zipcode" placeholder="Zipcode"/>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<form:input class="form-control"
						...
						id="shippingaddress.apartmentnumber" placeholder="Apartment number"/>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<form:input class="form-control" path="shippingaddress.streetname"
						id="shippingaddress.streetname" placeholder="Street name"/>
				</div>
			</div>
